...
const config = {
  ...
  url: 'https://choiscafe-portfolio.web.app/',
  baseUrl: '/',
  onBrokenLinks: 'warn',
  ...
  organizationName: 'choiscafe', // Usually your GitHub org/user name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/choiscafe/portfolio/blob/main/',
        },
        blog: {
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/choiscafe/',
            position: 'right',
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Chohye Han. Built with <a href="https://docusaurus.io" target="_blank">Docusaurus🦖</a>`,
      },
    }),
};
